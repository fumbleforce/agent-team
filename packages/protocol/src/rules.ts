...
export const DeferReason = z.enum(['agent-paused', 'task-blocked', 'task-closed', 'task-quarantined', 'checkout-quarantined', 'writer-busy', 'writers-busy', 'lane-busy', 'delivery-busy', 'provider-unavailable', 'provider-limited', 'provider-busy', 'provider-window', 'over-cap', 'over-budget', 'project-paused', 'no-worktree-holder', 'no-request', 'engine-missing', 'deferred']);
