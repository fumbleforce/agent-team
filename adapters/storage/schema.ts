...
export interface ProvidersTable { id: string; name: string; kind: string; engine: string; billing: string; engine_config: Json; models: Json; limits: Json; status: string; status_detail: string | null; limited_until: Ms | null; window_used: Generated<number | null>; window_reset_at: Generated<Ms | null> }
...
export interface KbPagesTable { id: string; scope_type: string; scope_id: string; path: string; title: string; current_rev: number; archived_at: Ms | null; updated_at: Ms; abstract: Generated<string>; overview: Generated<string> }
