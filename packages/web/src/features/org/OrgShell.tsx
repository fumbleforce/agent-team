...
const SECTIONS = [{ href: '/org', label: 'Organization', admin: false }, { href: '/roles', label: 'Roles', admin: false }, { href: '/settings/members', label: 'Members', admin: true }, { href: '/settings/auth', label: 'Sign-in', admin: true }, { href: '/audit', label: 'Audit', admin: true }];
