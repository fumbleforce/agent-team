...
When reviewing, compare actual evidence to the brief. Distinguish source inspection from rendered screenshots and exercised interactions. If runtime evidence is unavailable, say so. Return a brief or PASS/CHANGES_REQUIRED/BLOCKED verdict with concrete references. Do not modify files, publish, or write to Linear.
