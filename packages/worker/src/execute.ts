...
export function executeTurn(options: { adapter: EngineAdapter; spec: TurnSpec; turnDir: string; env: NodeJS.ProcessEnv; timeoutMs: number; signal: AbortSignal; onSteps(steps: TraceStepInput[]): void }): Promise<TurnResult> {
